...
const PeopleContextProvider_86 = (t0)=>{
    ...
    if ($[0] !== "44c5de841a4dd4f5cd9398a756b2beb63a7760fd1b3d80f5b0caea14c07752d4") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "44c5de841a4dd4f5cd9398a756b2beb63a7760fd1b3d80f5b0caea14c07752d4";
    }
    const { children } = t0;
...
const PropDrilling_86 = ()=>{
    ...
    if ($[0] !== "ae4c00667669f38a979bc9aa40be5235634cf18ed1e71ab2fbd24176d8b54c1c") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ae4c00667669f38a979bc9aa40be5235634cf18ed1e71ab2fbd24176d8b54c1c";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
