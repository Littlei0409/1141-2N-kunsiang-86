...
"[project]/src/app/(root)/tutorials/context/1_propdrilling_86/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PropDrilling_86 = ()=>{
    ...
    if ($[0] !== "1e2325538d5dd452bbbe99b66bed64d7d653c52f32416b03c990afd5225eb9d1") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1e2325538d5dd452bbbe99b66bed64d7d653c52f32416b03c990afd5225eb9d1";
    }
...
_s(PropDrilling_86, "1LkHEtj2RWqZMtew8JQSoeuNX/M=");
_c = PropDrilling_86;
const List = (t0)=>{
    ...
    const { people, removePerson } = t0;
    let t1;
    if ($[1] !== people || $[2] !== removePerson) {
        let t2;
        if ($[4] !== removePerson) {
            t2 = (person)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SinglePerson, {
                    ...person,
                    removePerson: removePerson
                }, person.id, false, {
                    fileName: "[project]/src/app/(root)/tutorials/context/1_propdrilling_86/page.jsx",
...
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "PropDrilling_86");
...
//# sourceMappingURL=_08c35a25._.js.map