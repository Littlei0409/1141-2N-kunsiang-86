...
const PropDrilling_28 = ()=>{
    ...
    if ($[0] !== "a2ae02b9de5a7ae64e6439b9bf12ff03ab15a37f0174602c243b73c9634e895b") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a2ae02b9de5a7ae64e6439b9bf12ff03ab15a37f0174602c243b73c9634e895b";
    }
    let t0;
...
const List = (t0)=>{
    ...
    const { people: people1, removePerson: removePerson1 } = t0;
    let t1;
    if ($[1] !== people1 || $[2] !== removePerson1) {
        let t2;
        if ($[4] !== removePerson1) {
...
const SinglePerson = (t0)=>{
    ...
    const { id, name, removePerson: removePerson1 } = t0;
    let t1;
    if ($[1] !== name) {
...
//# sourceMappingURL=_3288b169._.js.map